...
namespace VoxelWorldTemp.Rendering
{
    public class VoxelWorldRenderer : MonoBehaviour
    {
        ...
        [SerializeReference]
        AbstractVoxelWorldInstancedRendererProviderMonoBehaviour rendererProvider;
        ...
        {
            yield return new WaitUntil(() => rendererProvider.IsReady());
        }
        ...
        {
            if (!rendererProvider.IsReady()) return;
            ...
            VoxelWorldInstancedRenderer vRenderer = rendererProvider.GetRenderer();
